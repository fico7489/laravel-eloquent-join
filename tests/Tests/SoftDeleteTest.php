...
class SoftDeleteTest extends TestCase
{
    ...
    public function testRelatedOnlyTrashed()
    {
        ...
        $queryTest = '/select "order_items".* from "order_items" left join "orders" on "orders"."id" = "order_items"."order_id" where "order_items"."deleted_at" is not null group by "order_items"."id" order by "orders"."number" asc/';
        $this->assertRegExp($queryTest, $this->fetchQuery());
    }
    ...
    public function testRelatedWithTrashed()
    {
        ...
        $queryTest = '/select "order_items".* from "order_items" left join "orders" on "orders"."id" = "order_items"."order_id" group by "order_items"."id" order by "orders"."number" asc/';
        $this->assertRegExp($queryTest, $this->fetchQuery());
    }
}
